...
export const translations: Record<Language, Translations> = {
  cs: {
    ...
    playLocallyButton: 'Hrát Lokálně',
    playLocallyDescription: 'Hrajte proti botům na jednom zařízení.',
    playOnlineButton: 'Hrát Online',
    playOnlineDescription: 'Vyzvěte ostatní hráče z celého světa.',
    getFreeCoinsButton: 'Získat Coiny Zdarma',
    getFreeCoinsDescription: 'Sledujte reklamu a získejte odměnu.',
    ...
    videoPlaying: 'Video se přehrává...',
    getCoins: 'Získat',
    correct: 'Správně!',
    incorrect: 'Špatně!',
    ...
    submit: 'Odeslat',
    hint: 'Jistota ({0})',
    insufficientCoins: 'Nedostatek mincí',
  ...
  en: {
    ...
    playLocallyButton: 'Play Locally',
    playLocallyDescription: 'Play against bots on a single device.',
    ...
    getFreeCoinsDescription: 'Watch an ad to get a reward.',
    rulesButton: 'Rules',
  ...
  de: {
    ...
    playLocallyButton: 'Lokal spielen',
    playLocallyDescription: 'Spiele gegen Bots auf einem Gerät.',
    playOnlineButton: 'Online spielen',
    playOnlineDescription: 'Fordere andere Spieler aus der ganzen Welt heraus.',
    getFreeCoinsButton: 'Gratis-Münzen erhalten',
    getFreeCoinsDescription: 'Sieh dir eine Werbung an, um eine Belohnung zu erhalten.',
    rulesButton: 'Regeln',
    ...
    videoPlaying: 'Video wird abgespielt...',
    getCoins: 'Einfordern',
    correct: 'Richtig!',
    incorrect: 'Falsch!',
  ...
  es: {
    ...
    playLocallyButton: 'Jugar Localmente',
    playLocallyDescription: 'Juega contra bots en un solo dispositivo.',
    playOnlineButton: 'Jugar en Línea',
    playOnlineDescription: 'Desafía a otros jugadores de todo el mundo.',
    getFreeCoinsButton: 'Obtener Monedas Gratis',
    getFreeCoinsDescription: 'Mira un anuncio para obtener una recompensa.',
    rulesButton: 'Reglas',
    ...
    videoPlaying: 'El video se está reproduciendo...',
    getCoins: 'Reclamar',
    correct: '¡Correcto!',
